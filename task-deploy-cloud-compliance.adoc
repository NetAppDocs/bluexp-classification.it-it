...
I sistemi ONTAP on-premise, le condivisioni dei file NetApp, lo storage a oggetti generico S3 e i database possono essere sottoposti a scansione quando si utilizza uno di questi connettori cloud.
