...
--
====
Assicurarsi che BlueXP disponga delle autorizzazioni necessarie:: Assicurarsi che BlueXP disponga delle autorizzazioni per distribuire risorse e creare gruppi di sicurezza per l'istanza BlueXP classification .
+
--
...
. Dalla pagina _Installazione_, seleziona *Distribuisci > Distribuisci* per utilizzare la dimensione dell'istanza "Grande" e avviare la procedura guidata di distribuzione nel cloud.
...
. Una volta distribuita l'istanza e installata la BlueXP classification , selezionare *Continua alla configurazione* per andare alla pagina _Configurazione_.
...
. Selezionare *Distribuisci* per avviare la procedura guidata di distribuzione nel cloud.
+
