...
Puoi anche farlo link:task-licensing-datasense.html["Impostare la licenza BYOL per la classificazione BlueXP"] Dalla pagina del portafoglio digitale BlueXP. Non ti verrà addebitato alcun costo neanche dopo la fine della prova gratuita di 30 giorni.
