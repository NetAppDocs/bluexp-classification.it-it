...
=== Distribuzione su diversi tipi di istanza
...
* *Metadati standard* la classificazione BlueXP raccoglie metadati standard sui file: Il tipo di file, le sue dimensioni, le date di creazione e modifica e così via.
