...
| Policy | Selezionare una o più policy. Andare link:task-using-policies.html["qui"] a visualizzare l'elenco dei criteri esistenti e a creare criteri personalizzati. 
|===
