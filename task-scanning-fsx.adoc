...
Prima di eseguire la scansione di FSX per i volumi ONTAP, https://docs.netapp.com/us-en/cloud-manager-fsx-ontap/start/concept-fsx-aws.html["È necessario disporre di un ambiente di lavoro FSX con volumi configurati"^].
...
https://docs.netapp.com/us-en/cloud-manager-fsx-ontap/use/task-creating-fsx-working-environment.html["Scopri come individuare o creare il file system FSX per ONTAP in BlueXP"^].
