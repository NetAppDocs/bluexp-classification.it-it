...
| Notifica agli utenti tramite e-mail quando i file contengono determinati PII. (Questo criterio viene definito utilizzando link:task-using-policies.html["Policy"^].) | Sì | Sì 
