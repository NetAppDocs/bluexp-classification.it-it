...
. È necessario selezionare il sistema di destinazione e selezionare (o creare) il Data Broker che si desidera utilizzare. Esaminare i requisiti di copia e sincronizzazione di BlueXP a partire da link:https://docs.netapp.com/us-en/cloud-manager-sync/task-quick-start.html["Descrizione di avvio rapido"^].
