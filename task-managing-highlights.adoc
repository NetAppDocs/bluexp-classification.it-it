...
È possibile eliminare i file manualmente dal riquadro analisi, oppure link:task-using-policies.html#delete-source-files-automatically-using-policies["Utilizzo automatico dei criteri"^].
