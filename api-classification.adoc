...
summary: 'Le funzionalità BlueXP classification disponibili tramite l"interfaccia utente Web sono disponibili anche tramite l"API REST.' 
---
...
[role="lead"]
Le funzionalità BlueXP classification disponibili tramite l'interfaccia utente Web sono disponibili anche tramite l'API REST.
...
Per accedere al riferimento API, è necessario l'indirizzo IP dell'istanza BlueXP classification .  Se si dispone di una distribuzione cloud, utilizzare l'indirizzo ID pubblico. Per esempio:
