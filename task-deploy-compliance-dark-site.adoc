...
Se non si dispone già di un connettore installato sul sito on-premise offline, https://docs.netapp.com/us-en/bluexp-setup-admin/task-quick-start-private-mode.html["Implementare il connettore"^] Su un host Linux.
...
Se non si dispone già di un connettore BlueXP installato sul sito on-premise offline, https://docs.netapp.com/us-en/bluexp-setup-admin/task-quick-start-private-mode.html["Implementare il connettore"^] Su un host Linux nel tuo sito offline.
...
* Verificare che il software BlueXP Connector sia stato aggiornato alla versione più recente disponibile. https://docs.netapp.com/us-en/bluexp-setup-admin/task-managing-connectors.html#upgrade-the-connector-when-using-private-mode["Consultare la procedura di aggiornamento del connettore"^].
