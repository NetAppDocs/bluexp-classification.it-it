...
Le scansioni di classificazione BlueXP  identificano le categorie di dati PII canadesi per le informazioni bancarie, il numero di passaporto, il numero di assicurazione sociale, il numero di patente di guida e il numero di carta sanitaria per tutte le province e territori.
