...
Vedere https://regex101.com/[] se hai bisogno di assistenza nella creazione dell'espressione regolare di cui hai bisogno. Scegliere *Python* per il flavor per vedere i tipi di risultati che la classificazione BlueXP corrisponde all'espressione regolare.
