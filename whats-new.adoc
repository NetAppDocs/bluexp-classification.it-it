...
Per ulteriori informazioni, fare riferimento alla https://docs.netapp.com/us-en/bluexp-classification/task-scanning-storagegrid.html["Eseguire la scansione dei dati StorageGRID"].
